  ...
  return (
    <nav className='nav'>
      <div className='nav__wrapper'>
        <div className={currentScreen === 1 ? 'nav__item active' : 'nav__item'} onClick={() => setNavActive(1)}>
          <div className='nav__img'></div>
          <div className='nav__text'>Тренировки</div>
        </div>
        <div className={currentScreen === 2 ? 'nav__item active' : 'nav__item'} onClick={() => setNavActive(2)}>
          <div className='nav__img'></div>
          <div className='nav__text'>Задачи</div>
        </div>
        <div className={currentScreen === 3 ? 'nav__item active' : 'nav__item'} onClick={() => setNavActive(3)}>
          <div className='nav__img'></div>
          <div className='nav__text'>Питание</div>
        </div>
        <div className={currentScreen === 4 ? 'nav__item active' : 'nav__item'} onClick={() => setNavActive(4)}>
          <div className='nav__img'></div>
